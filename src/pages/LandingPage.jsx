    ...
    <Html center>
      <div className="flex flex-col justify-center items-center text-white z-20 w-screen h-screen px-4 py-2 rounded-lg relative">
        ...
        <div className="flex items-center my-6">
          <img src={logo} alt="Prarambh Development Cell" className="h-32 md:h-40 rounded-xl shadow-lg" />
        </div>
  ...
  return (
    <>
      <div className="relative text-[--color-neon] h-screen w-full flex justify-center items-center overflow-x-hidden ">
        ...
        <h1 className="absolute bottom-[28%] text-[7rem] md:hidden font-bold tracking-widest text-[#50ff53]  opacity-50" style={{ WebkitTextStroke: '6px #50ff53' }}>
          DAY
        </h1>
